...
public class DbConstants {
    ...
    public static final String SELECT_ITEMS_FOR_ORDER =
            "SELECT f.name AS name, f.price AS price, o.quantity AS quantity," +
                    "(price * quantity) AS amount FROM foodItem f INNER JOIN orderItem o" +
                    "ON f.id = o.itemId WHERE o.orderId = ?";
    public static final String SELECT_TOTAL_AMOUNT =
            "SELECT SUM(amount) as amount FROM (" + SELECT_ITEMS_FOR_ORDER + ") t";
